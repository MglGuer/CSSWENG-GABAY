document.addEventListener("DOMContentLoaded", function() {
    ...
    new Chart(ctx, {
        type: 'line', 
        data: {
            labels: [ '0 to 18 months (3)', '19 months to 9 years', '10 to 14 years (4)', '15 to 19 years (4)',
                '20 to 24 years (4)', '25 to 29 years', '30 to 39 years', '40 to 49 years', '50 years and older (5)' ],
            datasets: [
                {
                    label: 'Positive Male',
